...
export const projects: Project[] = [
  ...
  },
  {
    ...
    pinned: false,
    description:
      'Landing page que simula a apresentação de um produto de chatbot IA.',
    screenshot: '/images/brainwave.webp',
    alt: 'Landing page com navbar e apresentação do chatbot',
    repositoryUrl: 'https://github.com/davi-andrade-js/brainwave',
    liveUrl: 'https://brainwave-ten-plum.vercel.app/',
    technologies: [
      'JavaScript',
      'React',
      'Vite',
